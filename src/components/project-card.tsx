              ...
              {translatedProject.icon && (
                <img 
                  ...
                  className={`object-contain ${
                    ...
                    translatedProject.title === 'Biblia Viva' || translatedProject.title === 'ATC Radar AGP' || translatedProject.title === 'Eclisolar Web' || translatedProject.title === 'Kinema TV' ? 'h-28 w-28' : 'h-24 w-24'
                  }`}
