              ...
              {translatedProject.icon && (
                <img 
                  ...
                  className={`object-contain ${
                    ...
                    translatedProject.title === 'Biblia Viva' || translatedProject.title === 'ATC Radar AGP' || translatedProject.title === 'Eclisolar Web' || translatedProject.title === 'Kinema TV' || translatedProject.title === 'TrainX Explorer' ? 'h-28 w-28' : 'h-24 w-24'
                  }`}
